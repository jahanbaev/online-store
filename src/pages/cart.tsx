...
const Cart: FC<{clc: () => void;}> = (props) =>{
    ...
    const [products, setProductsLength] = useState<{length:number,total:number}>({length:0,total:0});
    ...
    <div className="w-[32rem] pt-[4.4rem] min-h-[100px] p-2">
        <div className="bg-white w-full h-full p-1 text-center">
            ...
            <button onClick={()=>setHidden(true)} className="bg-blue-700 text-white w-full h-10">Buy now</button>
        </div>
    </div>
    </div>
} 
